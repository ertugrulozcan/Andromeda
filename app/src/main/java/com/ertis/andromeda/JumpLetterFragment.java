...
public class JumpLetterFragment extends Fragment
{
	...
	private List<AppMenuItem> appMenuList;
	...
	public static JumpLetterFragment newInstance(List<AppMenuItem> appMenuList, RecyclerView recyclerView)
	{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		for(int index=0; index<((ViewGroup)keypadLayout).getChildCount(); ++index)
		{
			...
			if (nextChild instanceof Button)
			{
				...
				for (AppMenuItem menuItem : appMenuList)
				{
