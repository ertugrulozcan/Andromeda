...
public class SpannableGridLayoutManager extends TilesLayoutManagerBase
{
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state)
    {
        ...
        if (dy < 0)
        {
            ...
            View view = getChildAt(firstPositionOfLastRow - firstVisiblePosition);
            if (view != null)
            {
                int lastRowTop = getDecoratedTop(view);
