...
public abstract class PowerMenuBase<E, T extends MenuBaseAdapter> implements LifecycleObserver
{
	...
	protected PowerMenuBase(Context context) {
		initialize(context);
	}
	
	protected PowerMenuBase(Context context, AbstractMenuBuilder builder) {
		initialize(context);
	...
	protected void initialize(Context context) {
		...
		backgroundView = layoutInflater.inflate(com.skydoves.powermenu.R.layout.layout_power_background, null);
		...
		menuView = layoutInflater.inflate(R.layout.popup_menu, null);
		menuListView = menuView.findViewById(com.skydoves.powermenu.R.id.power_menu_listView);
		menuWindow = new PopupWindow(menuView, FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT);
		menuCard = menuView.findViewById(com.skydoves.powermenu.R.id.power_menu_card);
	...
	public void setAnimation(MenuAnimation menuAnimation) {
		if(menuAnimation == MenuAnimation.NONE)
			...
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.FadeMenuAnimation);
			backgroundWindow.setAnimationStyle(com.skydoves.powermenu.R.style.FadeMenuAnimation);
		}
		else if(menuAnimation == MenuAnimation.SHOWUP_BOTTOM_LEFT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ShowUpAnimation_BL);
		else if(menuAnimation == MenuAnimation.SHOWUP_BOTTOM_RIGHT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ShowUpAnimation_BR);
		else if(menuAnimation == MenuAnimation.SHOWUP_TOP_LEFT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ShowUpAnimation_TL);
		else if(menuAnimation == MenuAnimation.SHOWUP_TOP_RIGHT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ShowUpAnimation_TR);
		else if(menuAnimation == MenuAnimation.SHOW_UP_CENTER)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ShowUpAnimation_Center);
		else if(menuAnimation == MenuAnimation.ELASTIC_BOTTOM_LEFT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ElasticMenuAnimation_BL);
		else if(menuAnimation == MenuAnimation.ELASTIC_BOTTOM_RIGHT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ElasticMenuAnimation_BR);
		else if(menuAnimation == MenuAnimation.ELASTIC_TOP_LEFT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ElasticMenuAnimation_TL);
		else if(menuAnimation == MenuAnimation.ELASTIC_TOP_RIGHT)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ElasticMenuAnimation_TR);
		else if(menuAnimation == MenuAnimation.ELASTIC_CENTER)
			menuWindow.setAnimationStyle(com.skydoves.powermenu.R.style.ElasticMenuAnimation_Center);
	}
